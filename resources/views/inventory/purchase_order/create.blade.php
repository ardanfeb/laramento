    ...
    <div class="content-wrapper">
        ...
        <section class="content-header container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('inventory.purchase_order') }}">Purchase Order</a></li>
                <li class="active"><a href="{{ route('inventory.purchase_order.create') }}">Tambah</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Tambah Purchase Order</b>
                        </div>
                        <div class="panel-body">
                            
                            {{-- Form add store --}}
                            <form action="{{ route('inventory.purchase_order.store') }}" method="post">
                                {{ csrf_field() }}

                                {{-- Supplier --}}
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 form-group{{ $errors->has('supplier') ? ' has-error' : '' }}">
                                        <label>Supplier <b class="txtc-red">*</b></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 form-group">
                                        <label>Catatan <b class="txtc-red">*</b></label>
                                ...
                                <table class="table table-responsive table-striped table_array" style="margin-top:10px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:200px;">Harga Beli Satuan <span class="txtc-red">*</span></th>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p><b>Supplier</b> <span class="pull-right" id="supplier_show"></span></p>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function proses() {
            ...
            product_name = document.getElementsByClassName('product_name');
            ...
            document.getElementById('supplier_show').innerHTML = supplier.options[supplier.selectedIndex].text;
        ...
        function tambah() {
            var markup = "<tr>" +
                "<td><select name='product[]' class='form-control select2 product'><option selected disabled>Pilih Produk</option><?php foreach ($product as $item) { ?><option value='<?php echo $item->id ?>' label='<?php echo $item->product_name ?> - <?php echo $item->label_name ?>'><?php echo $item->product_name ?> - <?php echo $item->label_name ?></option><?php }; ?></select></td>" +
