    ...
    <div class="content-wrapper">
        ...
        <section class="content-header container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('inventory.purchase_order.show', $po->id) }}">{{ $po->code }}</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>{{ $po->code }}</b>
                            <b class="pull-right">Tanggal: {{ date('d/m/Y', strtotime($po->created_at)) }}</b>
                        </div>
                        <div class="panel-body">
                            <blockquote class="blockquote">
                                <p>{{ $po->note }}</p>
                                <footer class="blockquote-footer">Note</footer>
                            </blockquote>
                            ...
                            <b class="pull-left">Status: <span class="badge {{ $po->status == 'selesai' ? 'bgc-green' : 'bgc-yellow' }}" style="margin-left:5px;">{{ $po->status }}</span></b>
