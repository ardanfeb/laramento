    ...
    <div class="content-wrapper">
        ...
        <section class="content-header container-fluid">
            <ol class="breadcrumb">
                ...
                <a href="{{ route('inventory.stock_out.create') }}" style="position:relative;top:-6px;" class="btn btn-sm bgc-green pull-right"><i class="fas fa-plus-circle" style="margin-right:10px;"></i>Tambah Stok Keluar</a>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-responsive table-bordered table-striped" style="width:100%;" id="table-stokout">
                                <thead>
                                    <tr>
...
@section('js')
    ...
    <script type="text/javascript">
        $('#table-stokout').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('inventory.stock_out.data') }}',
            columns: [
                { data: 'code', name: 'code' },
